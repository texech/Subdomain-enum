...
# VirusTotal Subdomain Enumeration Script
API_KEY="d6887cb8001af1364xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
...
echo "Enumerating subdomains for $domain using VirusTotal..."
subdomains=$(curl -s -H "x-apikey: $API_KEY" \
