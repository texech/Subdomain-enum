...
# BeVigil Subdomain Enumeration Script
API_KEY="GcT1xxxxxxxxxxxxx"
...
echo "Enumerating subdomains for $domain using BeVigil..."
subdomains=$(curl -s -H "X-Access-Token: $API_KEY" \
